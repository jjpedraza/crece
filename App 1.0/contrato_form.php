...
<table style="display: inline-table;" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="495">
  ...
  <tr>
    <td align="center" valign="top">
      <p><span class="titulo" > VERIFICAR CONTRATO</span></p>
      <form id="contrato" name="contrato" method="GET" action="contrato.php">
        <p><span class="txtform">No. solicitud:</span><br />
          <label for="nosol"></label>
          <input type="text" name="nosol" id="nosol" />
