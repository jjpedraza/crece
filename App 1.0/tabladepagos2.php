...
while ($fila = mysql_fetch_array($resultado))
		...
		echo'<tr class="tabla">';
		echo '<td>'.$fila["no"].'</td>';
		echo'<td width="130">'.' '.fechacompleta($fila["inicio"]).'</td>';
		echo'<td width="150">'.fechacompleta($fila["fin"]).'</td>';

		echo'<td width="80">'.number_format($saldo,2,".",",").'</td>';
		$saldo=$saldo-$abonof;
        ...
        echo '<td width="100">';
         ...
         echo '</td>';}else{
		echo '<td width="70"><b>'.number_format($abonof,2,".",",").'</b></td>';}    
