...
$trabajo_nombre=$_POST["trabajo_nombre"];
...
fiscal_rfc='$fiscal_rfc',
fiscal_domicilio='$fiscal_domicilio',
minegocio_nombre='$minegocio_nombre',
...
trabajo_antiguedad='$trabajo_antiguedad',
minegocio_sueldos='$minegocio_sueldos',
minegocio_antiguedad='$minegocio_antiguedad',
ref1_antiguedad='$ref1_antiguedad',
ref2_antiguedad='$ref2_antiguedad',
ref3_nombre='$ref3_nombre',
ref3_tel='$ref3_tel',
ref3_domicilio='$ref3_domicilio',
ref3_antiguedad='$ref3_antiguedad',
...
fiscal_edo='$fiscal_edo',
socio_hogar='$socio_hogar',
socio_renta='$socio_renta',
socio_drenaje='$socio_drenaje',
socio_agualuz='$socio_agualuz',
socio_pisos='$socio_pisos',
socio_cuartos='$socio_cuartos',
socio_wc='$socio_wc',
socio_cocina='$socio_cocina',
socio_material='$socio_material',
socio_buro='$socio_buro'
WHERE curp='$curp'";
...
if(!mysql_query($sql))//checamos si hay curp
{
	...
	echo '<img src="img\bien.jpg">Datos del cliente actualizados correctamente<br>';	
