...
<table style="display: inline-table;" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="495">
  ...
  <tr>
    <td align="center" valign="top">
      <p><span class="titulo" > CAJA: crear cargos extraordinarios</span></p>
      <?php
	  ...
	  ?>
      <form id="form1" name="form1" method="post" action="caja_extra.php">
        <p>No.Contrato:<br />
        <?php
...
echo '</select>';
        ...
        <p>
          ...
          <br />
<input name="concepto" type="text" class="textbox" id="concepto" size="80" maxlength="80" />
        </p>
        <p>
