...
{     
    ...
    echo "<td valign=top style='text-align:left; font-size:10pt;'>Moratorios</td>";
        ...
        if ($DescuentosAutorizados <>""){
            echo "<a class='' style='padding:2px; margin-left:2px;' href='#Descuentosde".$NPago."' rel=MyModal:open title='Descuento Autorizado = ".$DescuentosAutorizados.", haz clic para ver mas...'><img src='icons/alerta2.png' style='width:16px;'></a>";
    ...
    echo "<td valign=top style='font-size:10pt;text-align:left;'>Cargos Semanales</td>";
        ...
        if ($DescuentosAutorizados <> ""){
            echo "<a class='' style='padding:2px; margin-left:2px;' href='#Descuentosde_cargosemanal".$NPago."' rel=MyModal:open title='Descuento Autorizado = ".$DescuentosAutorizados.", haz clic para ver mas...'><img src='icons/alerta2.png' style='width:16px;'></a>";
    ...
    if ($Sol['CargoExtraOrdinario_cantidad'] > 0){
        echo "<a class='' style='padding:2px; margin-left:2px;' href='#List_cargoextraordinario".$NPago."' rel=MyModal:open title='Ver los cargos...'><img src='icons/alerta2.png' style='width:16px;'></a>";
    }
    echo "</td>";
        ...
        if ($DescuentosAutorizados <> ""){
            echo "<a class='' style='padding:2px; margin-left:2px;' href='#Descuentosde_cargoextraordinario".$NPago."' rel=MyModal:open title='Descuento Autorizado = ".$DescuentosAutorizados.", haz clic para ver mas...'><img src='icons/alerta2.png' style='width:16px;'></a>";
    ...
    echo "<td valign=top style='text-align:left; font-size:10pt; cursor:pointer;' title='Interes de Financiamiento'><b>Fi</b>nanciamiento<br> <span style='font-size:7pt;'> (".PorcentajeFi($NoSol)."% Mensual)</span></td>";
        ...
        if ($DescuentosAutorizados <>""){
            echo "<a class='' style='padding:2px; margin-left:2px;' href='#DescuentosFide".$NPago."' rel=MyModal:open title='Descuento Autorizado = ".$DescuentosAutorizados.", haz clic para ver mas...'><img src='icons/alerta2.png' style='width:16px;'></a>";
    ...
    echo "<td valign=top style='text-align:left; font-size:10pt; cursor:pointer;' title='Interes de Financiamiento'>Capital</td>";
        ...
        if ($DescuentosAutorizados <>""){
            echo "<a class='' style='padding:2px; margin-left:2px;' href='#DescuentosCapitalde".$NPago."' rel=MyModal:open title='Descuento Autorizado = ".$DescuentosAutorizados.", haz clic para ver mas...'><img src='icons/alerta2.png' style='width:16px;'></a>";
